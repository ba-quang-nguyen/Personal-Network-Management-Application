      ...
      >
        ...
        {showCloseButton && (
          <DialogPrimitive.Close
            ...
            className="absolute top-4 right-4 rounded-sm opacity-70 ring-offset-background transition-opacity hover:opacity-100 focus:ring-1 focus:ring-ring focus:outline-none disabled:pointer-events-none"
          >
            <X className="size-4" />
